...
const Depart = () => {
  ...
  <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
    <div className="lg:w-3/5  md:pr-16 lg:pr-0 pr-0 grid md:grid-cols-3  grid-cols-1">
    <div className="flip-container w-40" ontouchstart="this.classList.toggle('hover');">
